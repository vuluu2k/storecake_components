import{F as v}from"./PhX.vue-BMjs3dqK.js";import{c as i,b as y,e as b,h as S,i as T,f as k,a as w,r as C,o as u}from"./iframe-DC2Z_nKe.js";import{_ as P}from"./_plugin-vue_export-helper-DlAUqK2U.js";const _={name:"Tags",components:{PhX:v},props:{size:{type:String,default:"md",validator:e=>["sm","md","lg"].includes(e)},type:{type:String,default:"primary",validator:e=>["secondary","primary","info","success","warning","error"].includes(e)},bordered:{type:Boolean,default:!1},closable:{type:Boolean,default:!1}},emits:["close"],methods:{handleClose(e){e.preventDefault(),this.$emit("close",e)}}},V={key:0,class:"tag-icon"},B={class:"tag-label"},D={class:"close-icon"};function N(e,g,s,$,I,f){const h=C("PhX");return u(),i("div",{class:w(["tag",`tag-${s.size}`,`tag-${s.type}`,{"tag-bordered":s.bordered}])},[e.$slots.icon?(u(),i("span",V,[S(e.$slots,"icon")])):y("",!0),b("span",B,[S(e.$slots,"default")]),s.closable?(u(),i("span",{key:1,class:"tag-close",onClick:g[0]||(g[0]=T((...z)=>f.handleClose&&f.handleClose(...z),["stop"]))},[b("span",D,[k(h,{size:14})])])):y("",!0)],2)}const E=P(_,[["render",N]]);_.__docgenInfo={displayName:"Tags",exportName:"default",description:"",tags:{},props:[{name:"size",type:{name:"string"},defaultValue:{func:!1,value:"'md'"},values:["sm","md","lg"]},{name:"type",type:{name:"string"},defaultValue:{func:!1,value:"'primary'"},values:["secondary","primary","info","success","warning","error"]},{name:"bordered",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"closable",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],events:[{name:"close",type:{names:["undefined"]}}],slots:[{name:"icon"},{name:"default"}],sourceFiles:["/home/runner/work/storecake_components/storecake_components/src/components/Tags.vue"]};const F={title:"Data Display/Tags",component:E,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],description:"Size of the Tags"},type:{control:"select",options:["secondary","primary","info","success","warning","error"],description:"Type of the Tags"},bordered:{control:"boolean",description:"Property bordered of the Tags"},closable:{control:"boolean",description:"Property closable of the Tags"}},args:{size:"md",type:"primary",bordered:!1,closable:!1}},r={args:{size:"md",type:"primary",bordered:!1,closable:!1}},a={args:{type:"secondary"}},o={args:{type:"primary"}},n={args:{type:"info"}},t={args:{type:"success"}},c={args:{type:"warning"}},l={args:{type:"error"}},d={args:{size:"sm"}},p={args:{size:"md"}},m={args:{size:"lg"}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'md',
    type: 'primary',
    bordered: false,
